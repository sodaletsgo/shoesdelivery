...
pluralCaseList.push( {plural: "shoppingLists", pascal: "ShoppingList"} )
pluralCaseList.push( {plural: "registerOrders", pascal: "RegisterOrders"} )
pluralCaseList.push( {plural: "ordermanagements", pascal: "Ordermanagement"} )

pluralCaseList.push( {plural: "viewOrderDetails", pascal: "ViewOrderDetails"} )
